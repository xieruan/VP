...
_CONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='networks', full_name='v2ray.core.proxy.dokodemo.Config.networks', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='v2ray.core.proxy.dokodemo.Config.timeout', index=4,
      ...
      serialized_options=b'\030\001', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='follow_redirect', full_name='v2ray.core.proxy.dokodemo.Config.follow_redirect', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='user_level', full_name='v2ray.core.proxy.dokodemo.Config.user_level', index=6,
...
_CONFIG.fields_by_name['networks'].enum_type = v2ray_dot_com_dot_core_dot_common_dot_net_dot_network__pb2._NETWORK
