...
from v2ray.com.core.app.router import config_pb2 as v2ray_dot_com_dot_core_dot_app_dot_router_dot_config__pb2
...
_NAMESERVER.fields_by_name['geoip'].message_type = v2ray_dot_com_dot_core_dot_app_dot_router_dot_config__pb2._GEOIP
